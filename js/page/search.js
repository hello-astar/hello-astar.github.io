(function() {
    ...
    SearchPage.prototype = {
        init: function() {
            [this.baseURL] = location.pathname.split('/search/');
                ...
                '<div class="page__post">',
                    '<article itemscope itemtype="http://schema.org/Article" class="page__mini-article">',
                        '<div class="mini-article__cover">',
                            ...
                            '</div>',
                            `<a itemprop="url" class="iconfont icon-enter" href="${this.baseURL}{{ url }}"></a>`,
                        '</div>',
                        '<div class="mini-article__info">',
                            '<h3 itemprop="name" class="mini-article__title">',
                                `<a itemprop="url" href="${this.baseURL}{{ url }}" title="{{ title }}">{{ title }}</a>`,
                            '</h3>',
        ...
        getData: function() {
            var self = this;
            axios
                .get(self.baseURL + '/assets/lunr/all.json')
